...
statisticsAction = new QAction(QIcon(":/icons/statistics"), tr("&Statistics"), this);
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a greenbacks address"));
...
connect(statisticsAction, SIGNAL(triggered()), this, SLOT(gotoStatisticsPage()));
    ...
    aboutCardAction = new QAction(tr("GreenBacks Website"), this);
    aboutCardAction->setToolTip(tr("Go to GreenBacks website"));
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About GreenBacks"), this);
    aboutAction->setToolTip(tr("Show information about greenbacks"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for greenbacks"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Show / Hide"), this);
    encryptWalletAction = new QAction(QIcon(":/icons/lock_closed"), tr("&Encrypt GreenBacks..."), this);
    encryptWalletAction->setToolTip(tr("Encrypt or decrypt wallet"));
    encryptWalletAction->setCheckable(true);
    backupWalletAction = new QAction(QIcon(":/icons/filesave"), tr("&Backup GreenBacks..."), this);
    backupWalletAction->setToolTip(tr("Backup GreenBacks to another location"));
    changePassphraseAction = new QAction(QIcon(":/icons/key"), tr("&Change Passphrase..."), this);
    changePassphraseAction->setToolTip(tr("Change the passphrase used for wallet encryption"));
    unlockWalletAction = new QAction(QIcon(":/icons/lock_open"), tr("&Unlock GreenBacks..."), this);
    unlockWalletAction->setToolTip(tr("Unlock GreenBacks"));
    lockWalletAction = new QAction(QIcon(":/icons/lock_closed"), tr("&Lock GreenBacks"), this);
    lockWalletAction->setToolTip(tr("Lock GreenBacks"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("greenbacks client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("greenbacks client"));
...
{
    QDesktopServices::openUrl(QUrl("http://www.thegreenbacks.in/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to greenbacks network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid greenbacks address or malformed URI parameters."));
    }
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelEncryptionIcon->setToolTip(tr("GreenBacks is <b>encrypted</b> and currently <b>unlocked</b>"));
    ...
    case WalletModel::Locked:
        ...
        labelEncryptionIcon->setToolTip(tr("GreenBacks is <b>encrypted</b> and currently <b>locked</b>"));
        encryptWalletAction->setChecked(true);
        changePassphraseAction->setEnabled(true);
...
void BitcoinGUI::backupWallet()
{
    ...
    QString filename = QFileDialog::getSaveFileName(this, tr("Backup GreenBacks"), saveDir, tr("GreenBacks Data (*.dat)"));
    if(!filename.isEmpty()) {
        if(!walletModel->backupWallet(filename)) {
            QMessageBox::warning(this, tr("Backup Failed"), tr("There was an error trying to save the GreenBacks data to the new location."));
        }
    }
}
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    else
    {
        ...
        if (pwalletMain && pwalletMain->IsLocked())
            labelStakingIcon->setToolTip(tr("Not staking because GreenBacks is locked"));
        else if (vNodes.empty())
            labelStakingIcon->setToolTip(tr("Not staking because GreenBacks is offline"));
        else if (IsInitialBlockDownload())
            labelStakingIcon->setToolTip(tr("Not staking because GreenBacks is syncing"));
        else if (!nWeight)
